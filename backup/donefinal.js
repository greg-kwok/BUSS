...
bot.onText(/📋 View Alerts/, (msg) => {
  ...
  bot.sendMessage(msg.chat.id, "⏰ Press a bus below to cancel:", {
...
bot.on('callback_query', async (query) => {
  ...
  try {
    if (data.startsWith('cancel_')) {
      ...
      await bot.sendMessage(chatId, '⏰ Press a bus below to cancel:', {
        reply_markup: { inline_keyboard: inlineButtons }
      });
...
bot.onText(/👶 Im just a baby/, (msg) => {
  bot.sendMessage(msg.chat.id, "Hello baby im your personal bot at your service.",{
    reply_markup: {
      keyboard: [
        [{ text: "🥱 Im Bored" }, { text:"👶 Im just a baby"}]
      ],
